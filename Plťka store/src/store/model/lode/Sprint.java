...
/**
 * Trieda <code>Sprint</code> rozširuje triedu {@link Disciplina} a implementuje vzhniezdené 
 * rozhranie Disciplina.CasProcesov. 
 * 
 * @author Lucia
 *
 */
public class Sprint extends Disciplina implements Disciplina.CasProcesov{
	...
	public int vyrob(Kajak lod) {
		...
		System.out.println("Novy sprintovy kajak.");
		return material;
	}
	...
	public int vyrob(Kanoe lod) {
		trvanieProcesu( zistiCasVyroby(lod, this) );
		System.out.println("Nove sprintove kanoe.");
		return material;
	}
